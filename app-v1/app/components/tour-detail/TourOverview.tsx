                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-0 mb-32 reveal-content border-y border-border divide-y md:divide-y-0 md:divide-x divide-border">
                    <div className="p-8 md:px-12 md:py-10 flex flex-col items-start justify-center group hover:bg-surface transition-colors duration-500">
                        <div className="flex items-center gap-3 mb-3 opacity-60 group-hover:opacity-100 transition-opacity">
                            ...
                            <span className="text-journal-data text-foreground">Altitud</span>
                        </div>
                        <span className="text-2xl md:text-3xl font-medium tracking-tight text-foreground">{tour.altitude.es}</span>
                    </div>
                    
                    <div className="p-8 md:px-12 md:py-10 flex flex-col items-start justify-center group hover:bg-surface transition-colors duration-500">
                        <div className="flex items-center gap-3 mb-3 opacity-60 group-hover:opacity-100 transition-opacity">
                            <Ruler className="w-4 h-4 text-blue-500" />
                            <span className="text-journal-data text-foreground">Distancia</span>
                        </div>
                    ...
                    <div className="p-8 md:px-12 md:py-10 flex flex-col items-start justify-center group hover:bg-surface transition-colors duration-500">
                        <div className="flex items-center gap-3 mb-3 opacity-60 group-hover:opacity-100 transition-opacity">
                            ...
                            <span className="text-journal-data text-foreground">Clima</span>
                        </div>
                        <span className="text-2xl md:text-3xl font-medium tracking-tight text-foreground">{tour.temperature.es}</span>
                    </div>
                    ...
                    <div className="p-8 md:px-12 md:py-10 flex flex-col items-start justify-center group hover:bg-surface transition-colors duration-500">
                        <div className="flex items-center gap-3 mb-3 opacity-60 group-hover:opacity-100 transition-opacity">
                            ...
                            />
                            <span className="text-journal-data text-foreground">Dificultad</span>
                        </div>
                ...
                <div className="flex flex-col md:flex-row gap-16 reveal-content">
                    <div className="md:w-1/2">
                        <div className="flex items-center gap-3 mb-8 border-b border-border pb-4">
                            <span className="text-sub-label text-foreground">Logística incluida</span>
                        </div>
                        <ul className="grid grid-cols-1 gap-5">
                            {tour.inclusions?.map((item, i) => (
                                <li key={i} className="flex items-baseline gap-4 group">
                                    ...
                                    <span className="text-body-std text-muted group-hover:text-foreground transition-colors">{item.es}</span>
                                </li>
                            ))}
                        </ul>
                    </div>
                    <div className="md:w-1/2 md:pl-12 md:border-l border-border">
                        <div className="flex items-center gap-3 mb-8 border-b border-border pb-4">
                            <span className="text-sub-label text-muted">No incluido</span>
                        </div>
                        <ul className="grid grid-cols-1 gap-5 opacity-60 hover:opacity-100 transition-opacity duration-500">
                            {tour.exclusions?.map((item, i) => (
                                <li key={i} className="flex items-baseline gap-4 group">
                                    ...
                                    <span className="text-body-std text-muted">{item.es}</span>
                                </li>
                            ))}
                        </ul>
                    </div>
