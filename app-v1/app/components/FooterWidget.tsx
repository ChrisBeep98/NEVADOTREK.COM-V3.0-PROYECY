            ...
            <div className="h-full w-full flex flex-col justify-center px-16 py-16 relative">
                ...
                <div className="relative z-10 space-y-12">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="text-[8rem] font-bold leading-none tracking-tighter bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent">
                            {formatTime()}
                        </div>
                    </div>
