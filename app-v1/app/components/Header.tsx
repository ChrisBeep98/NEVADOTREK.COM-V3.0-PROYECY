        ...
        <>
            <nav ref={navRef} className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center py-6 px-frame mix-blend-difference text-white/90">
                ...
                <div className="flex items-center gap-4 md:gap-8">
                    ...
                    <button className="hidden md:flex group border border-white/20 items-center justify-between pl-4 pr-1.75 py-2.5 rounded-full hover:bg-white hover:text-slate-950 transition-all font-normal text-[11px] tracking-[0.05em] capitalize h-[44px] w-[160px] hover:scale-105 header-reveal">
