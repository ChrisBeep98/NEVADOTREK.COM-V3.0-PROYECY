        ...
        <footer ref={containerRef} className="relative min-h-[100dvh] w-full bg-[#02040a] text-[#EDEDED] dark:bg-[#FAFAFA] dark:text-[#02040a] flex flex-col overflow-hidden z-50 transition-colors duration-500">
            ...
            <div className="flex-1 flex flex-col px-frame pt-24 md:pt-0 relative z-10 w-full justify-between pb-12 md:pb-0">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10 md:gap-0 mb-8 md:mb-12 flex-none">
                    ...
                    <div className="space-y-3 md:space-y-4">
                        ...
                        <a href="mailto:expeditions@nevadotrek.com" className="group flex items-center gap-2 text-2xl md:text-3xl font-medium hover:opacity-80 transition-opacity text-[#EDEDED] dark:text-[#02040a]">
                    ...
                    <nav className="flex flex-wrap gap-x-6 gap-y-3 md:gap-12">
                        {['Destinations', 'Journal', 'Team', 'Manifesto'].map((item) => (
                            <a key={item} href="#" className="text-lg md:text-xl font-medium text-[#EDEDED] dark:text-[#02040a] hover:text-cyan-500 dark:hover:text-cyan-600 transition-colors">
                                {item}
                            </a>
                        ))}
                    </nav>
            ...
            <div className="relative w-full flex-none">
                <div className="px-frame pt-4 pb-48 md:pb-32">
                   ...
                   */}
                   <h1 className="text-[17vw] leading-[0.75] tracking-tighter font-medium text-left select-none text-[#EDEDED]/40 dark:text-[#02040a]/40 transition-colors duration-500 -ml-[1.5vw] flex items-end overflow-visible drop-shadow-lg">
                        {/* Static Letters */}
                        <span>E</span>
                        <span>X</span>
                        <span>P</span>
                ...
                <div className="absolute bottom-6 left-0 w-full px-frame flex flex-col md:flex-row justify-between items-start md:items-center text-[10px] md:text-xs font-medium gap-6 md:gap-0">
                    ...
                    <div className="flex gap-4">
                        ...
                        <a href="#" className="w-12 h-12 rounded-full bg-white/10 dark:bg-black/5 flex items-center justify-center text-gray-400 dark:text-gray-600 transition-all duration-300 hover:text-white hover:bg-gradient-to-br hover:from-blue-600 hover:to-blue-400 hover:scale-110 hover:shadow-[0_0_15px_rgba(59,130,246,0.5)]">
                        ...
                        <a href="#" className="w-12 h-12 rounded-full bg-white/10 dark:bg-black/5 flex items-center justify-center text-gray-400 dark:text-gray-600 transition-all duration-300 hover:text-white hover:bg-gradient-to-br hover:from-purple-500 hover:via-pink-500 hover:to-orange-500 hover:scale-110 hover:shadow-[0_0_15px_rgba(236,72,153,0.5)]">
                            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
                        </a>

                        {/* WhatsApp - Green Gradient */}
                        <a href="#" className="w-12 h-12 rounded-full bg-white/10 dark:bg-black/5 flex items-center justify-center text-gray-400 dark:text-gray-600 transition-all duration-300 hover:text-white hover:bg-gradient-to-br hover:from-green-500 hover:to-emerald-400 hover:scale-110 hover:shadow-[0_0_15px_rgba(34,197,94,0.5)]">
